...
- [Input Files](#input-files)
	- [Step 1. Gene Expression File](#1-gene-expression-file)
	- [Step 2. Genotype Files for Training](#2-genotype-files-for-training)
	- [Step 3. Training BGW-TWAS](#3-training-BGW-TWAS)
